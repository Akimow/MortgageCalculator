...
import org.bank.model.MortgageResidual;
...
public class ResidualCalculationServiceImp implements ResidualCalculationService{
    ...
    public MortgageResidual calculate(RateAmounts rateAmounts, InputData inputData) {
        BigDecimal residualAmount = UtilsCalculation.getResidualAmount(rateAmounts, inputData);
    ...
    @Override
    public MortgageResidual calculate(RateAmounts rateAmounts, InputData inputData, Rate previousRate) {
    ...
    private BigDecimal calculateConstantResidualDuration(InputData inputData, BigDecimal residualAmount, RateAmounts rateAmounts) {
        // log_y(x) = log(x) / log (y)
        BigDecimal q = AmountsCalculationService.calculateQ(inputData.getInterestsPercent());
