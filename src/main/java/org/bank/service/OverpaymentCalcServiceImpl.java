...
public class OverpaymentCalcServiceImpl implements OverpaymentCalcService {
    ...
    return overpaymentAmount.multiply(inputData.getOverpaymentProvisionPercent().divide(BigDecimal.valueOf(100),2, RoundingMode.HALF_UP));
    }
